...
class AShooterCharacter : public ACharacter
{
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Game|Points")
	void GetPositions(TArray<FVector>& Locations) const;
...
public:
	...
	/** is the player's "camera" */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera)
	UCinematicCamera* CinematicCamera;
